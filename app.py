...
st.number_input("Avg Songs", min_value='0')
st.number_input("Avg Events", min_value='0')
st.number_input("Thumbs Up", min_value='0')
st.number_input("Thumbs Down", min_value='0')
st.number_input("Add Friend", min_value='0')
